...
if __name__ == '__main__':
    ...
    parser.add_argument('--layout', nargs='*', type=int, default=[500,])
    parser.add_argument('--batch_size', type=int, default=300)
    parser.add_argument('--first_phase_n', type=int, default=30000)
    parser.add_argument('--first_phase_epochs', type=int, default=10)
    parser.add_argument('--n', type=int, default=30000)
    parser.add_argument('--epochs', type=int, default=10)
    parser.add_argument('--phases', type=int, default=500)
